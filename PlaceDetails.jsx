        ...
        <Card elevation={6}>
            ...
            <CardContent>
                ...
                <Box display='flex' justifyContent='space-between'>
                    ...
                    <Typography gutterBottom varient='subtitle1'>out of 
                    {place.num_reviews}reviews</Typography>
                ...
                {place?.awards?.map((award)=>(
                    <Box my={1} display='flex' justifyContent='space-between' alignItems='center'>
                        ...
                        <Typography varient='subtitle2' color='textSecondary'>{award.display_name}
